...
export const ProductsProvider = ({ children }) => {
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true);
      setError(null);
      console.log('Fetching products from:', 'https://ecommerce-for-gadgets-backend.onrender.com/api/products');
      
      const response = await fetch('https://ecommerce-for-gadgets-backend.onrender.com/api/products');
