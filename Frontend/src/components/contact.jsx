    ...
    <div className="contact-container enhanced-contact">
      <div className="contact-grid">
        <div className="contact-form-card">
          <h1 className="contact-title">Contact Mani's Gadgets Support</h1>
        ...
        <aside className="contact-info-card">
          ...
          <p className="support-line"><strong>Email:</strong> support@manisgadgets.com</p>
          ...
          <div className="address">
            <h4>Visit Us</h4>
            <p>Mani's Gadgets HQ — Bangalore, India</p>
          </div>
        </aside>
      </div>
    </div>
