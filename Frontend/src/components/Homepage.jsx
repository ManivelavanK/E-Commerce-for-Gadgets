    ...
    <div className={`homepage ${isDarkMode ? 'dark-theme' : ''}`}>
      ...
      <section className="hero-section">
        <div className="hero-content">
          <div className="hero-text">
            <h1 className="hero-title">🏠 HOMEPAGE - Welcome to Gadgetory Mart</h1>
      ...
      <section className="features-section">
        <div className="container">
          <h2 className="section-title">Why Choose Gadgetory Mart?</h2>
      ...
      <section className="categories-preview">
        <div className="container">
          ...
          <div className="categories-grid">
            ...
            <Link to="/products" className="category-card">
              <img src="https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=300" alt="Cameras" />
              <div className="category-overlay">
                <h3>Cameras</h3>
                <p>Capture perfect moments</p>
              </div>
            </Link>
            <Link to="/products" className="category-card">
              <img src="https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=300" alt="Gaming" />
              <div className="category-overlay">
                <h3>Gaming</h3>
            ...
            <Link to="/products" className="category-card">
              <img src="https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=300" alt="Speakers" />
              <div className="category-overlay">
                <h3>Speakers</h3>
